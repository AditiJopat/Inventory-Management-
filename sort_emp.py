...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        ...
        <select id="sort" name="sort" style="margin-left: 10px; padding: 5px; border: 1px solid #800000;">
            ...
            <option value="dateofleaving">Date of leaving</option>
            <option value="Depid">Department ID</option>
...
print("<th class='nav__title'>FIrst Name</th>")
print("<th class='nav__title'>Middle Name</th>")
print("<th class='nav__title'>Last Name</th>")
print("<th class='nav__title'>Designation ID</th>")
print("<th class='nav__title'>Joining Date</th>")
...
print("<th class='nav__title'>Email ID</th>")
