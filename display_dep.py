...
if "action" in form and form["action"].value == "Display":
...
<head>
    ...
    <style>
        ...
        .header-container {
            display: flex;
            justify-content: flex-start; /* Adjusted to left */
            align-items: left;
            padding: 10px;
            width: 100%;
            top: 0;
            z-index: 1000;
            text-align: centre; /* Adjusted to left */
...
<footer class="footer">
    ...
    <div class="footer__section">
        <h2 class="nav__title" style="color: white;">Landline:</h2>
        <ul class="nav__ul" style="color: white;">
            <li>
                <a href="tel:040-xxxx-123" style="color: white;">040-xxxx-123</a>
            </li>
        </ul>
    </div>
    
    <div class="footer__section">
        <h2 class="nav__title" style="color: white;">Address:</h2>
        <ul class="nav__ul" style="color: white;">
            <li>
                <a href="#" style="color: white;">Koheda Road, Ibrahimpatnam</a>
            </li>
        </ul>
    </div>
</footer>
...
""")
# Insert the CSS styles to adjust the table size
print("<style>")
print("table {")
print("    border-collapse: collapse;")
print("    width: 65%;")  # Increase table width to 90%
print("    margin: auto;")  # Center the table horizontally
print("}")
print("th, td {")
print("    border: 1px solid #80#800000;")
print("    padding: 8px;")
...
print("<div class='employee-details' style='text-align: left; padding-top: 50px; color: #800000;'>")  # Add padding between heading and table and change text color
print("<h1 style='color: #800000; font-size: 22px; font-weight: bold; text-align: left;'>  Department Table Details :-</h1>")
print("<div style='overflow-x:auto; padding-top: 20px;'>")  # Add padding to the table container
print("<table>")  # Add border to the table
...
if "employees" in locals():
    ...
    print("<tr><td colspan='14'>No department details found.</td></tr>")
print("</table>")
print("</div>")
print("</div>")
