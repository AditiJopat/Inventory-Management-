...
print("<tr><th style='padding: 10px; border: 1px solid #ccc;'>S.NO</th><th style='padding: 10px; border: 1px solid #ccc;'>ITEMID</th><th style='padding: 10px; border: 1px solid #ccc;'>SUPPLIERID</th><th style='padding: 10px; border: 1px solid #ccc;'>QUANTITY</th><th style='padding: 10px; border: 1px solid #ccc;'>AMOUNT</th></tr>")
...
for _ in range(6):
    print("<tr style='height: 50px;'>")
    for _ in range(5):  # 5 columns in total including empty cells for Amount
