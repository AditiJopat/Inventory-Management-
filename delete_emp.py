...
def delete_employee(eid):
    try:
        ...
        print("<p>Error deleting employee details: {}</p>".format(str(e)))

# Form to input employee ID for deletion
print("<div style='text-align: center; padding: 20px;'>")
print("<form method='post' action=''>")
print("<label for='eid' style='color: #800000; font-weight: bold;'>Enter Employee ID to Delete:</label>")
print("<input type='text' id='eid' name='eid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
...
if "action" in form and form["action"].value == "Delete":
    if "eid" in form:
        ...
        print("<p>No Employee ID provided for deletion.</p>")
