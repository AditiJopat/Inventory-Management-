...
print("<nav class='flex flex-wrap items-start text-base justify-center md:justify-start'></nav>")
print("</div>")
print("</header>")
...
print("<h1 style='color: #800000; font-size: 27px; font-weight: bold; text-align: left;padding-left:10px;'>  Item History :-</h1>")
print("<div style='overflow-x:auto; padding-top: 60px;'>")  # Add padding to the table container
print("<table style='margin: auto; border: 1px solid #800000;width:80%;'>")  # Add border to the table
print("<tr>")
print("<th class='nav__title'>RV No</th>")
print("<th class='nav__title'>Item ID</th>")
print("<th class='nav__title'>Amount</th>")
print("<th class='nav__title'>RV Date</th>")
print("<th class='nav__title'>Payment Mode</th>")
print("<th class='nav__title'>Employee ID</th>")
...
if "employees" in locals():
    ...
    print("<tr><td colspan='14'>No rv table details found.</td></tr>")
print("</table>")
print("</div>")
print("</div>")
