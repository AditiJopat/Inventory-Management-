...
if "action" in form:
    ...
    if action == "Display":
        ...
        cursor.execute("SELECT * FROM itemtable WHERE supid LIKE ?", ('%' + search_query + '%',))
        suppliers = cursor.fetchall()
...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        <label for='search' style='color: #800000; font-weight: bold;'>Search Supplier by ID or Name:</label>
...
# Add some spacing between navbar and "Item Details" heading
...
# Add some padding between "Item Details" heading and the table
print("<div class='suppliers-details' style='text-align: left; padding-top: 10px; color: #800000;'>")  # Add padding between heading and table and change text color
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>suppliers Details</h1>")
...
print("<th class='nav__title'>itemname</th>")
print("<th class='nav__title'>supid</th>")
print("<th class='nav__title'>rvnumber</th>")
print("<th class='nav__title'>orderdate</th>")
print("<th class='nav__title'>arrivaldate</th>")
print("<th class='nav__title'>quantity</th>")
print("<th class='nav__title'>damagedpieces</th>")
print("<th class='nav__title'>fairpieces</th>")
print("<th class='nav__title'>priceperitem</th>")
print("<th class='nav__title'>amount</th>")
print("<th class='nav__title'>quantityleft</th>")
print("</tr>")
if "suppliers" in locals():
    for supplier in suppliers:
        print("<tr>")
        for field in supplier:
            print("<td style='word-wrap: break-word; border: 1px solid #800000;'>{}</td>".format(field))
        print("</tr>")
else:
    print("<tr><td colspan='10'>No suppliers found.</td></tr>")
print("</table>")
