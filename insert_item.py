...
# Function to insert new item details
def insert_item(itemid,itemname,supplierid,):
    try:
        cursor.execute("INSERT INTO itemtable (itemid,itemname,supplierid) VALUES (?, ?, ?)",
                       (itemid,itemname,supplierid,))
        conn.commit()
        print("<p>New item details inserted successfully.</p>")
    except Exception as e:
        print("<p>Error inserting new item details: {}</p>".format(str(e)))

# Form to input new Item details for insertion
print("<div style='text-align: center; padding: 20px;'>")
print("<form method='post' action=''>")
print("<label for='itemid' style='color: #800000; font-weight: bold;'>Iten ID:</label>")
print("<input type='text' id='itemid' name='itemid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;' required>")
print("<br>")
print("<label for='itemname' style='color: #800000; font-weight: bold;'>Item Name:</label>")
print("<input type='text' id='itemname' name='itemname' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;' required>")
print("<br>")
print("<label for='supplierid' style='color: #800000; font-weight: bold;'>supplierid:</label>")
print("<input type='text' id='supplierid' name='supplierid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
...
if "action" in form and form["action"].value == "Insert":
    ...
    supplierid= form.getvalue("supplierid")
    insert_item(itemid,itemname,supplierid,)

# Add the button to check the Item details
print("<div style='text-align: center; padding: 20px;'>")
