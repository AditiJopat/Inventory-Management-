...
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>  RV Table Details :-</h1>")
...
print("<th class='nav__title'>paymentdate</th>")
print("<th class='nav__title'>modeofpayment</th>")
print("<th class='nav__title'>recievedbyempid</th>")
