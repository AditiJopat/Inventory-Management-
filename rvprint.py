...
print("<th style='padding: 10px; border: 1px solid #ccc;'>RV Number</th>")
print("<th style='padding: 10px; border: 1px solid #ccc;'>Item ID</th>")
print("<th style='padding: 10px; border: 1px solid #ccc;'>Amount</th>")
print("<th style='padding: 10px; border: 1px solid #ccc;'>Payment Date</th>")
...
for i, row in enumerate(indent_data, start=1):
    ...
    for item in row[:6]:  # Adjusted to print only the first 5 columns
...
for _ in range(7):
    print("<tr style='height: 50px;'>")  # Adjust the height as needed
    for _ in range(7):  # 6 columns in total including empty cells for Amount and Remarks
