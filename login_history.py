...
if "action" in form and form["action"].value == "Display":
    cursor.execute("SELECT * FROM loginout")
...
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>  Login Logout History :-</h1>")
...
print("<th class='nav__title'>Login Time</th>")
print("<th class='nav__title'>Login Date</th>")
