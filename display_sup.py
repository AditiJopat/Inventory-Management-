...
if "action" in form and form["action"].value == "Display":
    cursor.execute("SELECT supid, sname, area || ', ' || locality || ', ' || pincode AS address, emailid, phoneno1, phoneno2, phoneno3,blacklisted FROM suppliers")
...
print("<div class='suppliers-details' style='text-align: left; padding-top: 0px; color: #800000;'>")  # Add padding between heading and table and change text color
...
print("<tr>")
print("<th class='nav__title'>Supplier ID</th>")
print("<th class='nav__title'>Supplier Name</th>")
print("<th class='nav__title'>Address</th>")
print("<th class='nav__title'>Phone No1</th>")
print("<th class='nav__title'>Phone No2</th>")
print("<th class='nav__title'>phone No3</th>")
print("<th class='nav__title'>Blacklisted</th>")
...
if "suppliers" in locals():
    ...
    print("<tr><td colspan='14'>No suppliers found.</td></tr>")
print("</table>")
print("</div>")
print("</div>")
