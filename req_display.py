...
# Fetch data from the requirement table
requirements = []
...
# Add some spacing between navbar and "Requirement Details" heading
...
# Add some padding between "Requirement Details" heading and the table
print("<div class='requirement-details' style='text-align: left; padding-top: 10px; color: #800000;'>")  # Add padding between heading and table and change text color
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>Requirement Details</h1>")
...
print("<th class='nav__title'>ReqDate</th>")
print("</tr>")
if requirements:
    ...
    print("<tr><td colspan='4'>No requirements found.</td></tr>")
print("</table>")
print("</div>")
print("</div>")
