...
print("<div class='employee-details' style='text-align: left; color: #800000;'>")  # Add padding between heading and table and change text color
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>  Issue Table Details :-</h1>")
print("<div style='overflow-x:auto; '>")  # Add padding to the table container
...
print("<th class='nav__title'>IV Number</th>")
print("<th class='nav__title'>Quantity</th>")
print("<th class='nav__title'>Rv Number</th>")
print("<th class='nav__title'>Date of Leaving </th>")
