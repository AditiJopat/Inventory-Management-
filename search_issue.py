...
if "action" in form:
    ...
    if action == "Display":
        ...
        cursor.execute("SELECT * FROM  issuevoucher WHERE itemid LIKE ?", ('%' + search_query + '%',))
        suppliers = cursor.fetchall()
...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        <label for='search' style='color: #800000; font-weight: bold;'>Search issue voucher by ID or Name:</label>
...
print("<th class='nav__title'>rv number</th>")
print("<th class='nav__title'>dateofleaving</th>")

print("<table style='margin: auto; border: 1px solid #800000;'>")
print("<tr>")
...
if "suppliers" in locals():
    ...
    print("<tr><td colspan='14'>No issue voucher found.</td></tr>")
print("</table>")
