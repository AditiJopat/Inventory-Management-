...
<header class='text-gray-600 body-font navbar' style='background-color: #800000;'>
    <div class='container mx-auto relative flex flex-wrap p-3 flex-col md:flex-row items-start' style='margin-top: -40px;padding-top:10px;padding-bottom:10px '>
        <nav class='flex flex-wrap items-start text-base justify-start'>
...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        <label for='search' style='color: #800000; font-weight: bold;'>Search Employee by ID or Name:</label>
