...
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>  Loginout  Details :-</h1>")
...
print("<th class='nav__title'>logintime</th>")
print("<th class='nav__title'>logouttime</th>")
print("<th class='nav__title'>logdate</th>")
