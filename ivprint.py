...
if row:
    ...
    print("<div style='text-align: left; margin-bottom: -10px; margin-left: 10px;'>")
    print(f"<p>IV NO: {row[3]} &nbsp;&nbsp;</p>")  # Display formatted date as IV Number
    ...
    print("<th style='padding: 10px; border: 1px solid #ccc;'>Date</th>")
    ...
    print(f"'<td style='padding: 10px; border: 1px solid #ccc;'>{row[0]}</td>")  # Issue Date
    print(f"<td style='padding: 10px; border: 1px solid #ccc;'>{row[1]}</td>")  # Item Name
    print(f"<td style='padding: 10px; border: 1px solid #ccc;'>{row[2]}</td>")  # Quantity
    print(f"<td style='padding: 10px; border: 1px solid #ccc;'>{row[3]}</td>")  # Department
    print("</tr>")

    # Add six empty rows
    for _ in range(6):
        print("<tr style='height: 50px;'>")  # Adjust the height as needed
        for _ in range(5):  # Adjusted to print only the first 5 columns
